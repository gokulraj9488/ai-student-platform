    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative" style={{ zIndex: 2 }}>
        ...
        <div className="text-center mb-6">
          <img src="/Kurio.png" alt="Kurio" className="w-16 h-16 md:w-20 md:h-20 rounded-full mx-auto mb-3 object-cover" style={{ border: '3px solid rgba(139,92,246,0.5)' }} />
          <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight">Kuriosity</h1>
          <p className="text-purple-400 mt-1 text-xs md:text-sm font-medium tracking-widest uppercase">Your AI Student Awaits</p>
        </div>
