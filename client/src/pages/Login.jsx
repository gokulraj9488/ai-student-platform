  ...
  return (
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none" style={{ zIndex: 1 }}>
        <div style={{ width: 500, height: 500, background: 'radial-gradient(circle, rgba(59,130,246,0.1) 0%, transparent 70%)', borderRadius: '50%' }} />
      </div>
      ...
      <div className="w-full max-w-sm relative" style={{ zIndex: 2 }}>
        ...
        <div className="text-center mb-6">
          <img src="/Kurio.png" alt="Kurio" className="w-16 h-16 md:w-20 md:h-20 rounded-full mx-auto mb-3 object-cover" style={{ border: '3px solid rgba(99,102,241,0.5)' }} />
          <h1 className="text-3xl md:text-4xl font-bold text-white tracking-tight">Kuriosity</h1>
          <p className="text-blue-400 mt-1 text-xs md:text-sm font-medium tracking-widest uppercase">Teach · Learn · Discover</p>
        </div>
        ...
        <div style={{
          ...
          <div className="space-y-3">
            ...
            {/* Google login */}
            <button
              onClick={() => alert('Google login coming soon! Please use email for now.')}
          ...
          <p className="text-center text-gray-500 text-sm mt-5">
            ...
            <Link to="/register" className="text-blue-400 hover:text-blue-300 transition">Register</Link>
          </p>
        </div>
